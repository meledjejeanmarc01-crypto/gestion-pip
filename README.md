...
- Structures, hiérarchie géographique complète, secteurs, bailleurs
- CRUD des projets avec filtres, budgets, décaissements, dépenses (avec pièce
  justificative), tâches/activités
- Tableau de bord temps réel (KPI, graphiques Chart.js, illustrations sectorielles)
- Carte interactive du territoire (Leaflet)

## 8. Reste à compléter

- Vues indicateurs / documents / bailleurs / rapports PDF-Excel (§7.9 à §7.12
  du cahier des charges)
- Interface de gestion des utilisateurs et des structures
- Export PDF/Excel (Laravel-DomPDF / Maatwebsite Excel conseillés)
